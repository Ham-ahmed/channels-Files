...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/channels-Files/main/channels_backup_A-Hussein_20240715_141837.tar.gz"
