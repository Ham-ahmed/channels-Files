...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/channels-Files/main/channels_backup_Ciefp_20240915_003229.tar.gz"
